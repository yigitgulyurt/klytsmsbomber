...
while 1:
 ...
 ░▒▓█▓▒░░▒▓█▓▒░░▒▓█▓▒░░▒▓█▓▒░░▒▓█▓▒░░▒▓█▓▒░░▒▓████████▓▒░    ░▒▓█▓▒░    ░▒▓█▓▒░░▒▓█▓▒░   ░▒▓█▓▒░                                                                                      
    ...
    try:
        menu = (input(Fore.LIGHTWHITE_EX + " 1- SMS Gönder " + Fore.LIGHTRED_EX + "\n\n 2- Çıkış\n\n" + Fore.WHITE + " Seçim: "))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "Hatalı giriş yaptınız,doğru seçenek giriniz (1 veya 2).")
        sleep(1)
        continue
    if menu == 1:
        system("cls||clear")
        print(Fore.WHITE + "Telefon numarasını yazınız: " + Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        tel_liste = []
        if tel_no == "":
            system("cls||clear")
            print(Fore.WHITE + "Telefon numaralarının kayıtlı olduğu dosyanın dizinini yazınız: "+ Fore.LIGHTGREEN_EX, end="")
            dizin = input()
            try:
        ...
        system("cls||clear")
        try:
            print(Fore.WHITE + "Gönderilecek sms sayısını giriniz: "+ Fore.LIGHTGREEN_EX, end="")
            kere = input()
            if kere:
                kere = int(kere)
            else:
        ...
        system("cls||clear")
        try:
            print(Fore.WHITE + "Kaç saniye aralıkla göndermek istiyorsun: "+ Fore.LIGHTGREEN_EX, end="")
            aralik = int(input())
        except ValueError:
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "Hatalı giriş. Tekrar deneyiniz.") 
        ...
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "Gizli Turbo Mod\n\n" + Fore.WHITE + "Telefon numarasını yazınız: "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        try:
            int(tel_no)
            if len(tel_no) != 10:
